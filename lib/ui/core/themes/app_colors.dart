...
class AppColors {
  ...
  static const Color primary = Color(0xFF12194d);
  static const Color black = Colors.black;
  static const Color white = Colors.white;
  static const Color grey = Color(0xFFF1F2F4);
  static const Color grey2 = Color(0xFFDCE1E4);
  ...
  static Color blackShadowLight = Colors.black.withOpacity(0.1);
  static const Color black87Light = Colors.black87;
  static const Color whiteLight = Colors.white;
  static const greyLight = Colors.grey;
  static Color greyShadowLight = Colors.grey.withOpacity(0.2);
  ...
  static const Color orangeLight = Colors.orange;
  static const Color blueLight = Colors.blue;
  static const Color backgroundLight = whiteLight;
}
